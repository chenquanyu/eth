...
async function testMaasConfig() {
  ...
  // // set node white
  // tx = await contract.setNodeWhite(signers[0].address, true);
  // console.log(tx.hash);
  // receipt = await tx.wait();
  // console.log(receipt.status);
  // console.log('isInNodeWhite: ', (await contract.isInNodeWhite(signers[0].address)));

  // tx = await contract.setNodeWhite(signers[1].address, true);
  // console.log(tx.hash);
  // receipt = await tx.wait();
  // console.log(receipt.status);
  // console.log('isInNodeWhite: ', (await contract.isInNodeWhite(signers[1].address)));

  // tx = await contract.setNodeWhite(signers[2].address, true);
  // console.log(tx.hash);
  // receipt = await tx.wait();
  // console.log(receipt.status);
  // console.log('isInNodeWhite: ', (await contract.isInNodeWhite(signers[2].address)));
  // console.log('getNodeWhitelist: ', (await contract.getNodeWhitelist()));

  // tx =  await contract.enableNodeWhite(true);
  // console.log(tx.hash);
  // receipt = await tx.wait();
  // console.log(receipt.status);
  // console.log('isNodeWhiteEnabled: ', (await contract.isNodeWhiteEnabled()));
